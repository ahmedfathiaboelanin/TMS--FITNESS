...
function calculate(){
        if(gender.value=="male"){
                if(typeof weight.value !== Number || typeof age.value !== Number || typeof length.value !== Number){
                        alert("information required")
                }
                else if(fat=="" || fat.value > 13 || fat.value < 6){
                ...
                else if(fat=="" || fat.value > 20 || fat.value < 14){
